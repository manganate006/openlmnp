...
- **234 automated tests** — Pest PHP, 629 assertions ([details](docs/TESTS.md), in French)
...
| [Test coverage](docs/TESTS.md) | Breakdown of the 234 automated tests, suite by suite |
...
**234 Pest PHP tests, 629 assertions** — calculation services, Filament pages, multi-user
