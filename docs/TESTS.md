...
OpenLMNP est couvert par **722 tests automatisés (2 044 assertions)** écrits avec
...
| Suites ajoutées depuis (détail non ventilé) | 287 | Coffre-fort, IA, orphelins d'exercices, avis in-app, import annuel, estimation DVF de la valeur vénale, justificatifs restés à la racine d'avant Laravel 11… |
| **Total** | **722** | **2 044 assertions** |
