...
OpenLMNP est couvert par **779 tests automatisés (2 179 assertions)** écrits avec
...
| Suites ajoutées depuis (détail non ventilé) | 336 | Coffre-fort, IA, orphelins d'exercices, avis in-app, import annuel, estimation DVF de la valeur vénale, justificatifs restés à la racine d'avant Laravel 11, traitements des frais d'acquisition, valeur brute des actifs, rapport de diagnostic, formulaires annoncés… |
| **Total** | **779** | **2 179 assertions** |
