...
OpenLMNP est couvert par **720 tests automatisés (2 033 assertions)** écrits avec
...
| Suites ajoutées depuis (détail non ventilé) | 285 | Coffre-fort, IA, orphelins d'exercices, avis in-app, import annuel, estimation DVF de la valeur vénale, justificatifs restés à la racine d'avant Laravel 11… |
| **Total** | **720** | **2 033 assertions** |
