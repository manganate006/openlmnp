...
OpenLMNP est couvert par **727 tests automatisés (2 055 assertions)** écrits avec
...
| Suites ajoutées depuis (détail non ventilé) | 292 | Coffre-fort, IA, orphelins d'exercices, avis in-app, import annuel, estimation DVF de la valeur vénale, justificatifs restés à la racine d'avant Laravel 11… |
| **Total** | **727** | **2 055 assertions** |
