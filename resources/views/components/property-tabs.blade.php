...
<style>
    .pt-tabs { display: flex; gap: 0; margin-bottom: 20px; background: var(--olmnp-surface-muted); border-radius: 10px; padding: 4px; width: fit-content; }
    .pt-tab { display: inline-flex; align-items: center; gap: 6px; padding: 8px 20px; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; text-decoration: none; background: transparent; color: var(--olmnp-fg-muted); transition: all 0.2s; }
    .pt-tab:hover { color: var(--olmnp-fg); }
    .pt-tab-active { background: var(--olmnp-surface); color: var(--olmnp-success-accent); box-shadow: 0 1px 3px rgba(0,0,0,.1); }
