<div class="ctx-help">
    ...
    <p>Pour une maison, vous pouvez ajouter des composants spécifiques en ajustant les pourcentages :</p>
    <ul>
        <li data-icon="&#x1F3CA;"><strong>Piscine</strong> &mdash; 15 à 20 ans. Quote-part appliquée si partagée avec usage personnel.</li>
        <li data-icon="&#x2744;"><strong>Climatisation / chauffage</strong> &mdash; 15 ans</li>
        <li data-icon="&#x1F373;"><strong>Cuisine équipée</strong> &mdash; 10 ans</li>
        <li data-icon="&#x1F6A7;"><strong>VRD (voirie, réseaux)</strong> &mdash; 25 à 30 ans (raccordements, allée, portail)</li>
        <li data-icon="&#x1F333;"><strong>Aménagements extérieurs</strong> &mdash; 15 à 20 ans (terrasse, clôture, jardin paysager)</li>
    </ul>
    ...
    <p>Vous pouvez ajuster les pourcentages et les durées. Le total des pourcentages doit faire <strong>100 %</strong>. En cas de doute, consultez un expert-comptable.</p>
