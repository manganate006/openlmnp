<x-filament-widgets::widget>
    ...
    @foreach($alerts as $alert)
        <a href="{{ $alert['url'] }}" style="display:flex;align-items:center;gap:0.75rem;padding:0.75rem 1rem;border-radius:0.75rem;background:var(--olmnp-danger-bg);border:1px solid var(--olmnp-danger-border);color:var(--olmnp-danger-fg);font-size:0.875rem;font-weight:500;text-decoration:none;">
