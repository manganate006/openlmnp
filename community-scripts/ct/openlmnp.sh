...
echo -e "${INFO}${YW} Create your administrator account on first visit:${CL}"
echo -e "${TAB}${GATEWAY}${BGN}http://${IP}/register${CL}"
echo -e "${INFO}${YW} The first account becomes the administrator, then sign-up closes by itself.${CL}"
