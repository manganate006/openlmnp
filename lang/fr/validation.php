...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Messages d'erreur par défaut du validateur. Ils alimentent aussi bien les
    | formulaires Filament que les requêtes API : sans ce fichier, toute l'app
    | affiche « The :attribute field is required. » en anglais.
    |
    | ⚠️ Les marqueurs (:attribute, :value, :min, :max, :other, :values…) doivent
    | rester strictement identiques à la version anglaise du framework —
    | LocalizationTest vérifie cette parité clé par clé.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Convention « attribut.règle » pour surcharger un message précis.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Remplace le marqueur :attribute par un libellé plus lisible. Filament
    | injecte déjà le label du champ, ce tableau reste donc vide.
    |
    */
