...
for var in APP_KEY APP_NAME APP_LOCALE APP_FALLBACK_LOCALE DEMO_MODE DEMO_TTL_HOURS DEMO_MAX_ACCOUNTS DEMO_EMAIL \
    DEMO_REMINDERS DEMO_REMINDER_MIN_GAP_HOURS DEMO_EXTENDED_TTL_DAYS DEMO_URL_PRO DEMO_IFRAME_TIMEOUT_MS \
    MCP_ENABLED MCP_DEMO_ENABLED MCP_DEMO_TOKEN MCP_DEMO_RATE_LIMIT \
    GITHUB_TOKEN GITHUB_REPO GTM_CONTAINER_ID GTM_SERVER_URL GTM_SCRIPT_PATH CONSENT_COOKIE_DOMAIN \
    ALLOW_REGISTRATION PROVISION_TOKEN APP_URL TRUSTED_PROXIES UPDATE_SELF_APPLY UPDATE_DOCKER_IMAGE \
